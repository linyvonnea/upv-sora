...
export function OnlineActivitySection() {
  return (
    <div id="online" className="mx-auto my-12 w-full max-w-[1000px]">
      <h2 className="text-xl font-bold mb-4 text-[#8E1537]">Online Activity</h2>
      ...
      <div className="bg-white rounded-lg shadow p-6 border w-full mt-10">
        ...
        <div className="italic text-s text-gray-500">
